...
sudo kubeadm init --pod-network-cidr=192.168.0.0/16 --control-plane-endpoint=k8master.supportlab.infoblox.com --apiserver-advertise-address=10.192.36.5 --apiserver-cert-extra-sans=k8master.supportlab.infoblox.com
...
curl https://raw.githubusercontent.com/projectcalico/calico/refs/heads/release-v$CALICO_VERSION/manifests/calico.yaml -O
